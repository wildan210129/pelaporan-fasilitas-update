                        ...
                        <div class="flex flex-col sm:flex-row gap-3 w-full md:w-auto">
                            ...
                            <div class="relative flex-1">
                                ...
                                <input
                                    ...
                                    class="w-full sm:w-64 rounded-xl border-gray-300 pl-10 focus:border-blue-500 focus:ring-blue-500">
                    ...
                    <table class="min-w-full" id="tableLokasi">
                        ...
                        <thead class="bg-gradient-to-r from-blue-600 to-blue-700 text-white">
                            ...
                            <tr>
                                ...
                                <th class="px-4 py-4 text-center w-60">
                                    Aksi
                                </th>
                                ...
                                <td class="px-6 py-4">
                                    ...
                                    <div class="flex flex-col sm:flex-row justify-center gap-2">
                                        ...
                                        <button
                                            ...
                                            class="w-full sm:w-auto bg-amber-400 hover:bg-amber-500 text-white px-4 py-2 rounded-xl shadow font-medium transition">
                                        ...
                                        <button
                                            ...
                                            class="w-full sm:w-auto bg-red-500 text-white px-4 py-2 rounded-xl shadow font-medium transition">
